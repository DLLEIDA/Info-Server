        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                if (args.Length == 0)
                {
                    ...
                    refDoc = "T013020181021120180315093216";
                ...
                if (refDoc != "")
                {
                    ...
                    if (tipDoc == "T0126")
                        {
                            Aspose.Words.Document doc = new Aspose.Words.Document(docTemplate + "T126.dot");
                            Aspose.Words.DocumentBuilder builder = new Aspose.Words.DocumentBuilder(doc);
                            foreach (Aspose.Words.Bookmark bookmark in doc.Range.Bookmarks)
                            {
                                switch (bookmark.Name)
                    ...
                    if (tipDoc == "T00142")
                        {
                            Aspose.Words.Document doc = new Aspose.Words.Document(docTemplate + "T142.dot");
                            Aspose.Words.DocumentBuilder builder = new Aspose.Words.DocumentBuilder(doc);
                            foreach (Aspose.Words.Bookmark bookmark in doc.Range.Bookmarks)
                            {
                                switch (bookmark.Name)
                    ...
                    if (tipDoc == "T00114")
                        {
                            Aspose.Words.Document doc = new Aspose.Words.Document(docTemplate + "T114.dot");
                            Aspose.Words.DocumentBuilder builder = new Aspose.Words.DocumentBuilder(doc);
                            foreach (Aspose.Words.Bookmark bookmark in doc.Range.Bookmarks)
                            {
                                switch (bookmark.Name)
                    ...
                    if (tipDoc == "T0116")
                     ...
                     if (tipDoc == "T0174")
                     {
                         Aspose.Words.Document doc = new Aspose.Words.Document(docTemplate + "T174.dot");
                         Aspose.Words.DocumentBuilder builder = new Aspose.Words.DocumentBuilder(doc);
                         foreach (Aspose.Words.Bookmark bookmark in doc.Range.Bookmarks)
                         {
                             switch (bookmark.Name)
